...
const DeviceApprovalPage = () => {
  ...
  const handleApprove = async () => {
    ...
    try {
      ...
      toast.success("Device Approving Successfully")
      router.push("/");
...
return (
  <div className="flex items-center justify-center bg-background font-sans h-screen">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative">
              ...
              <div className="absolute -top-2 -right-2 w-8 h-8 bg-orange-500 rounded-full border-2 border-zinc-900 flex items-center justify-center">
                <span className="text-as text-while font-bold">!</span>
              </div>
            </div>
          </div>
